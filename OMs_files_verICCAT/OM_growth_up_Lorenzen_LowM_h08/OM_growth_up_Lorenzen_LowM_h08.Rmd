...
plot_composition_RCM(Year, CAL_plot, RCMdata@CAL[, , 1], CAL_bins = RCMdata@Misc$lbin_mid, dat_col = scenario$col)
}
```
...
if(any(RCMdata@CAL[, , 1] > 0, na.rm = TRUE)) {
plot_composition_RCM(Year, CAL_plot, CAL_bins = RCMdata@Misc$lbinmid, dat_col = scenario$col)
}
```
...
plot_composition_RCM(Year, CAL_plot, RCMdata@CAL[, , 2], CAL_bins = RCMdata@Misc$lbin_mid, dat_col = scenario$col)
}
```
...
plot_composition_RCM(Year, CAL_plot, RCMdata@CAL[, , 3], CAL_bins = RCMdata@Misc$lbin_mid, dat_col = scenario$col)
}
```
...
plot_composition_RCM(Year, CAL_plot, RCMdata@CAL[, , 4], CAL_bins = RCMdata@Misc$lbin_mid, dat_col = scenario$col)
}
```
...
plot_composition_RCM(Year, CAL_plot, RCMdata@CAL[, , 5], CAL_bins = RCMdata@Misc$lbin_mid, dat_col = scenario$col)
}
```
...
plot_composition_RCM(Year, pred_IAL, RCMdata@IAL[, , 1], CAL_bins = RCMdata@Misc$lbinmid, dat_col = scenario$col)
}
```
...
plot_composition_RCM(Year, pred_IAL, RCMdata@IAL[, , 2], CAL_bins = RCMdata@Misc$lbinmid, dat_col = scenario$col)
}
```
...
plot_composition_RCM(Year, pred_IAL, RCMdata@IAL[, , 3], CAL_bins = RCMdata@Misc$lbinmid, dat_col = scenario$col)
}
```
...
plot_composition_RCM(Year, pred_IAL, RCMdata@IAL[, , 4], CAL_bins = RCMdata@Misc$lbinmid, dat_col = scenario$col)
}
```
...
plot_composition_RCM(Year, pred_IAL, RCMdata@IAL[, , 5], CAL_bins = RCMdata@Misc$lbinmid, dat_col = scenario$col)
}
```
