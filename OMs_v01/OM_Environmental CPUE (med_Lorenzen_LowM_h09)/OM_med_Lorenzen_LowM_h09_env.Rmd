...
matplot(Year, Ipred, type = "l", col = scenario$col, lty = scenario$lty, lwd = scenario$lwd, ylim = c(0, 1.1 * max(c(Ipred, RCMdata@Index[, 1]), na.rm = TRUE)), xlab = "Year", ylab = "LL_USMX")
...
matplot(Year, Ipred, type = "l", col = scenario$col, lty = scenario$lty, lwd = scenario$lwd, ylim = c(0, 1.1 * max(c(Ipred, RCMdata@Index[, 2]), na.rm = TRUE)), xlab = "Year", ylab = "HL_RR")
...
matplot(Year, Ipred, type = "l", col = scenario$col, lty = scenario$lty, lwd = scenario$lwd, ylim = c(0, 1.1 * max(c(Ipred, RCMdata@Index[, 3]), na.rm = TRUE)), xlab = "Year", ylab = "BB_West_Hist")
...
```{r, fig.cap = "Selectivity of PS_West_env in last historical year."}
if(!is.null(report_list[[1]]$ivul)) {
ivul_ff_age <- sapply(report_list, function(x) x$ivul[nyears, , 4])
matplot(age, ivul_ff_age, type = "l", col = scenario$col2, xlab = "Age", ylim = c(0, 1), ylab = "Selectivity of PS_West_env")
abline(h = 0, col = "grey")
if(!is.null(scenario$names)) legend("topleft", scenario$names, col = scenario$col2, lty = scenario$lty, lwd = scenario$lwd)
}
```
...
```{r, fig.cap = "Observed (black) and predicted (red) index values for PS_West_env."}
Ipred <- sapply(report_list, function(x) x$Ipred[, 4])
matplot(Year, Ipred, type = "l", col = scenario$col, lty = scenario$lty, lwd = scenario$lwd, ylim = c(0, 1.1 * max(c(Ipred, RCMdata@Index[, 4]), na.rm = TRUE)), xlab = "Year", ylab = "PS_West_env")
...
```{r, fig.cap = "Observed (black) and predicted (red) index values for PS_West_env. Error bars indicate 95% confidence intervals for observed values."}
if(length(RCMdata@I_sd) && any(RCMdata@I_sd > 0, na.rm = TRUE)) {
  II <- RCMdata@Index[, 4]
  ind <- seq(min(which(!is.na(II))), max(which(!is.na(II))), 1)
  err <- exp(log(II) + outer(RCMdata@I_sd[, 4], c(-1.96, 1.96)))
  matplot(Year[ind], Ipred[ind, , drop = FALSE], type = "l", col = scenario$col, lty = scenario$lty, lwd = scenario$lwd, ylim = c(0, 1.1 * max(c(Ipred[ind, ], II[ind], err[ind, ]), na.rm = TRUE)), xlab = "Year", ylab = "PS_West_env")
  points(Year[ind], II[ind], lwd = 3, pch = 16)
  arrows(Year[ind], y0 = err[ind, 1], y1 = err[ind, 2], length = 0, lwd = 1.5)
  abline(h = 0, col = "grey")
  if(!is.null(scenario$names)) legend("topleft", scenario$names, col = scenario$col, lty = scenario$lty, lwd = scenario$lwd)
...
```{r, fig.cap = "Observed (black) and predicted (red) mean ages from PS_West_env."}
...
```{r, fig.cap = "Observed (black) and predicted (red) mean lengths from PS_West_env."}
...
```{r, fig.cap = "Observed (black) and predicted (red) age composition from PS_West_env."}
if(length(RCMdata@IAA) && any(RCMdata@IAA[, , 4] > 0, na.rm = TRUE)) {
...
```{r, fig.cap = "Observed (black) and predicted (red) length composition from PS_West_env."}
if(length(RCMdata@IAL) && any(RCMdata@IAL[, , 4] > 0, na.rm = TRUE)) {
...
```{r, fig.cap = "Selectivity of BB_West_env in last historical year."}
if(!is.null(report_list[[1]]$ivul)) {
ivul_ff_age <- sapply(report_list, function(x) x$ivul[nyears, , 5])
matplot(age, ivul_ff_age, type = "l", col = scenario$col2, xlab = "Age", ylim = c(0, 1), ylab = "Selectivity of BB_West_env")
abline(h = 0, col = "grey")
if(!is.null(scenario$names)) legend("topleft", scenario$names, col = scenario$col2, lty = scenario$lty, lwd = scenario$lwd)
}
```
...
```{r, fig.cap = "Observed (black) and predicted (red) index values for BB_West_env."}
Ipred <- sapply(report_list, function(x) x$Ipred[, 5])
matplot(Year, Ipred, type = "l", col = scenario$col, lty = scenario$lty, lwd = scenario$lwd, ylim = c(0, 1.1 * max(c(Ipred, RCMdata@Index[, 5]), na.rm = TRUE)), xlab = "Year", ylab = "BB_West_env")
...
```{r, fig.cap = "Observed (black) and predicted (red) index values for BB_West_env. Error bars indicate 95% confidence intervals for observed values."}
if(length(RCMdata@I_sd) && any(RCMdata@I_sd > 0, na.rm = TRUE)) {
  II <- RCMdata@Index[, 5]
  ind <- seq(min(which(!is.na(II))), max(which(!is.na(II))), 1)
  err <- exp(log(II) + outer(RCMdata@I_sd[, 5], c(-1.96, 1.96)))
  matplot(Year[ind], Ipred[ind, , drop = FALSE], type = "l", col = scenario$col, lty = scenario$lty, lwd = scenario$lwd, ylim = c(0, 1.1 * max(c(Ipred[ind, ], II[ind], err[ind, ]), na.rm = TRUE)), xlab = "Year", ylab = "BB_West_env")
  points(Year[ind], II[ind], lwd = 3, pch = 16)
  arrows(Year[ind], y0 = err[ind, 1], y1 = err[ind, 2], length = 0, lwd = 1.5)
  abline(h = 0, col = "grey")
  if(!is.null(scenario$names)) legend("topleft", scenario$names, col = scenario$col, lty = scenario$lty, lwd = scenario$lwd)
...
```{r, fig.cap = "Observed (black) and predicted (red) mean ages from BB_West_env."}
...
```{r, fig.cap = "Observed (black) and predicted (red) mean lengths from BB_West_env."}
...
```{r, fig.cap = "Observed (black) and predicted (red) age composition from BB_West_env."}
if(length(RCMdata@IAA) && any(RCMdata@IAA[, , 5] > 0, na.rm = TRUE)) {
...
```{r, fig.cap = "Observed (black) and predicted (red) length composition from BB_West_env."}
if(length(RCMdata@IAL) && any(RCMdata@IAL[, , 5] > 0, na.rm = TRUE)) {
...
plot_timeseries(Year, RCMdata@Index[, 1], report$Ipred[, 1], label = "LL_USMX")
```

```{r, fig.cap = "Observed (black) and predicted (red) index from survey 2."}
plot_timeseries(Year, RCMdata@Index[, 2], report$Ipred[, 2], label = "HL_RR")
```

```{r, fig.cap = "Observed (black) and predicted (red) index from survey 3."}
plot_timeseries(Year, RCMdata@Index[, 3], report$Ipred[, 3], label = "BB_West_Hist")
```

```{r, fig.cap = "Observed (black) and predicted (red) index from survey 4."}
plot_timeseries(Year, RCMdata@Index[, 4], report$Ipred[, 4], label = "PS_West_env")
```

```{r, fig.cap = "Observed (black) and predicted (red) index from survey 5."}
plot_timeseries(Year, RCMdata@Index[, 5], report$Ipred[, 5], label = "BB_West_env")
```
...
plot_residuals(Year[istart:istop], log(RCMdata@Index[, 1][istart:istop]/report$Ipred[, 1][istart:istop]), label = "LL_USMX Residuals")
```
...
plot_residuals(Year[istart:istop], log(RCMdata@Index[, 2][istart:istop]/report$Ipred[, 2][istart:istop]), label = "HL_RR Residuals")
```
...
plot_residuals(Year[istart:istop], log(RCMdata@Index[, 3][istart:istop]/report$Ipred[, 3][istart:istop]), label = "BB_West_Hist Residuals")
```
...
plot_residuals(Year[istart:istop], log(RCMdata@Index[, 4][istart:istop]/report$Ipred[, 4][istart:istop]), label = "PS_West_env Residuals")
```
...
plot_residuals(Year[istart:istop], log(RCMdata@Index[, 5][istart:istop]/report$Ipred[, 5][istart:istop]), label = "BB_West_env Residuals")
```
